...
export const EVENTS: GameEvent[] = [
  ...
  // ------------------------------------------------- pasados (asistencia)
  {
    ...
    date: '2026-06-14',
    startTime: '08:00',
    location: 'Fundo Río Claro, Melipilla',
    mapsQuery: 'Melipilla, Chile',
    description: 'MILSIM 8 horas.',
    fpsLimits: [],
    reminders: [],
    files: [],
    comms: [],
    assignments: [],
    attended: ['1b9', '2b9', '5b9', '7b9', '8b9', '12b9', '13b9', '14b9'],
  },
  {
    id: 'e-past-2',
    name: 'SKIRMISH MAYO',
    ...
    comms: [],
    assignments: [],
    attended: ['1b9', '2b9', '3b9', '9b9', '10b9', '12b9', '14b9'],
  },
  {
    id: 'e-past-3',
    name: 'ENTRENAMIENTO NAVEGACIÓN',
    type: 'Entrenamiento',
    date: '2026-04-19',
    startTime: '10:00',
    location: 'Cajón del Maipo',
    mapsQuery: 'Cajón del Maipo, Chile',
    description: 'Navegación terrestre con brújula y coordenadas.',
    fpsLimits: [],
    reminders: [],
    files: [],
    comms: [],
    assignments: [],
    attended: ['1b9', '2b9', '5b9', '8b9', '12b9'],
  },
];
